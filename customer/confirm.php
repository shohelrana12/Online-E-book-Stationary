...
<head>
    ...
    <title>Online E-Book Stationary</title>
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <?php 
                    ...
                    if(isset($_POST['confirm_payment'])){
                        ...
                        $update_user_order = "update user_orders set order_status='$complete' where order_id='$update_id'";
                        
                        $run_user_order = mysqli_query($con,$update_user_order);
