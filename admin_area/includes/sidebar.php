            ...
            <ul class="dropdown-menu"><!-- dropdown-menu begin -->
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_Books"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-envelope"></i> Books
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_cats"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-gear"></i> Book Categories
                        
                        <span class="badge"><?php echo $count_b_categories; ?></span>
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="products" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_book"> Insert Book </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#p_cat"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-edit"></i> Books Categories
                        <i class="fa fa-fw fa-caret-down"></i>
